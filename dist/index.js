...
const replicate_1 = __webpack_require__(963);
core.setOutput('tags', replicate_1.replicate(inputs_1.getInputs()));
...
exports.getInputs = () => {
    ...
    const image = typeof imageInput === 'string' && imageInput.length > 0
        ? imageInput
        : undefined;
